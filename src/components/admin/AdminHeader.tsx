...
export function AdminHeader() {
  ...
  return (
    <header
      className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-border bg-card/80 px-4 backdrop-blur-sm lg:px-6"
      style={branding?.primary_color ? { borderBottomColor: `${branding.primary_color}33` } : undefined}
    >
      ...
      <div className="flex items-center gap-1.5 lg:gap-3 shrink-0">
        ...
        >
          ...
          <span className="hidden xs:inline sm:inline">{t("common.quick")}</span>
        </Button>
